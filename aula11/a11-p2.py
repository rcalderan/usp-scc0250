...
modelo = load_model_from_file('sword/sword.obj')
### inserindo vertices do modelo no vetor de vertices
...
### inserindo coordenadas de textura do modelo no vetor de texturas
### carregando textura equivalente e definindo um id (buffer): use um id por textura!
load_texture_from_file(4,'sword/Textures/Sting_Base_Color.png')



modelo = load_model_from_file('pistola/pistola.obj')
### inserindo vertices do modelo no vetor de vertices
print('Processando modelo pistola.obj. Vertice inicial:',len(vertices_list))
for face in modelo['faces']:
    for vertice_id in face[0]:
        vertices_list.append( modelo['vertices'][vertice_id-1] )
    for texture_id in face[1]:
        textures_coord_list.append( modelo['texture'][texture_id-1] )
print('Processando modelo pistola.obj. Vertice final:',len(vertices_list))
load_texture_from_file(5,'pistola/textures/handgun_C.jpg')

modelo = load_model_from_file('caixatex/caixatex.obj')
### inserindo vertices do modelo no vetor de vertices
print('Processando modelo caixaTex.obj. Vertice inicial:',len(vertices_list))
for face in modelo['faces']:
    for vertice_id in face[0]:
        vertices_list.append( modelo['vertices'][vertice_id-1] )
    for texture_id in face[1]:
        textures_coord_list.append( modelo['texture'][texture_id-1] )
print('Processando modelo caixaTex.obj. Vertice final:',len(vertices_list))
### inserindo coordenadas de textura do modelo no vetor de texturas
### carregando textura equivalente e definindo um id (buffer): use um id por textura!
load_texture_from_file(6,'caixaTex/caixaTex.png')
...
def desenha_espada():      
    ...
    # desenha o modelo
    glDrawArrays(GL_QUADS , 7584, 12776-7584) ## renderizando
...
def desenha_pistola():      
    ...
    # translacao
    t_x = -5.0; t_y = 0.0; t_z = 15.0
    
    # escala
    s_x = 1.2; s_y = 1.20; s_z = 1.20
    ...
    # desenha o modelo
    glDrawArrays(GL_QUADS, 12776, 56438-12776) ## renderizando
...
def desenha_caixa2():
    ...
    # translacao
    t_x = 0.0; t_y = 40.0; t_z = 0
    
    # escala
    s_x = 40.0; s_y = 47; s_z = 40.0
    ...
    # desenha o modelo
    glDrawArrays(GL_QUADS, 56438, 56474-56438) ## renderizando
